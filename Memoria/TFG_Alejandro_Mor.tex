...
La criptografía tiene una historia muy extensa, existiendo pruebas de sus primeros usos hace 4000 años, pasando por las primeras implementaciones en los sistemas informáticos hasta llegar al momento actual. Ligado al aumento del acceso a los sistemas informáticos surgió una nueva demanda de acceso a medios de protección de información digital, lo cual sirvió como estímulo para la investigación y obtención de nuevas técnicas y métodos de mantenimiento seguro de la información almacenada en los sistemas informáticos. Existen infinidad de motivos interesantes para mantener información digital privada de forma segura, desde garantizar la privacidad y confidencialidad de cualquier tipo de datos almacenados en un ordenador hasta proporcionar métodos de 
...
\begin{itemize}
    ...
    % \item \textbf{Caracteres desconocidos}: aunque parezca simple, si un ataque del arco iris se implementa sobre contraseñas que contienen caracteres que no aparecen en ninguna de sus tablas el resultado no será satisfactorio
...
% \chapter{La tabla del arco iris}

% La primera implementación de una tabla del arco iris vino dada por Philippe Oechslin \cite{rainbow} en el año 2003.
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.4]{resM1.png}
%    \caption{Porcentajes de éxito para las tablas empleando R1}
%    \label{resR1}
%\end{figure}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.4]{resHex}
%    \caption{Porcentajes de éxito para las tablas empleando R2}
%    \label{resR2}
%\end{figure}
...
En cuanto a las tablas que entrelazan ambas funciones de reconstrucción (\textbf{R1 + R2}) se obtiene:
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.4]{resR1R2.png}
%    \caption{Porcentajes de éxitos para las tablas empleando R1 + R2}
%    \label{resR1R2}
%\end{figure}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{|c|r|c|c|c|c|c|c|c|c|c|c|c|c|c|}
		...
		& & \multicolumn{13}{|c|}{$m$} \\ \hline
	\end{tabular}}
	\caption{Porcentajes de éxito para las tablas empleando \textbf{R1 + R2}}
	\label{resR1R2}
\end{table}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.4]{resPG.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.4]{respp.png}
%    \caption{Porcentajes de éxito para las tablas empleando el patrón pequeño}
%    \label{respp}
%\end{figure}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{colM1.png}
%    \caption{Porcentajes de colisiones para las tablas empleando R1}
%    \label{colR1}
%\end{figure}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{colHex.png}
%    \caption{Porcentajes de colisiones para las tablas empleando R2}
%	 \label{colR2}
%\end{figure}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{colR1R2.png}
%    \caption{Porcentajes de colisiones para las tablas empleando R1 + R2}
%    \label{colR1R2}
%\end{figure}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{|c|r|c|c|c|c|c|c|c|c|c|}
		...
		& & \multicolumn{9}{c|}{$m$} \\ \hline
	\end{tabular}}
	\caption{Porcentajes de colisiones para las tablas empleando \textbf{R1 + R2}}
	\label{colR1R2}
\end{table}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{colPG.png}
...
Por último, las tablas que emplean el denominado patrón pequeño (\textbf{R1 + R2 + R2}) generan los siguientes resultados:
\\
\\
\\
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{colpp.png}
%    \caption{Porcentajes de colisiones para las tablas empleando el patrón pequeño}
%    \label{colpp}
%\end{figure}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{exM1.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{exHex.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{exR1R2.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{exPG.png}
%    \caption{Porcentajes de éxito para las tablas que emplean el patrón grande}
%    \label{exPG}
%\end{figure}
...
Por último, realizando el ataque con las tablas que emplean el denominado patrón pequeño (\textbf{R1 + R2 + R2}) pueden obtenerse los siguientes resultados:
\\
%\begin{figure}[H]
%    \centering
%    \includegraphics[scale=0.5]{expp.png}
%    \caption{Porcentajes de éxito para las tablas que emplean el patrón pequeño}
%    \label{expp}
%\end{figure}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{|c|r|c|c|c|c|c|c|c|c|c|}
		...
		& & \multicolumn{9}{c|}{$m$} \\ \hline
	\end{tabular}}
	\caption{Porcentajes de éxito para las tablas que emplean patrón pequeño}
	\label{expp}
\end{table}
