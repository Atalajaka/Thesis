    ...
    for p in ps:
        ...
        if (aux):
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 3) or (patron == 4) or (patron == 8)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 2) or (patron == 3) or (patron == 7)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 1) or (patron == 2) or (patron == 6)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 1) or (patron == 5) or (patron == 8)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 4) or (patron == 7) or (patron == 8)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 3) or (patron == 6) or (patron == 7)):
                        r = str(h % 1000000)
            ...
            if (not aux):
                ...
                patron = 1
                for i in range(pf):
                    if ((patron == 2) or (patron == 5) or (patron == 6)):
                        r = str(h % 1000000)
...
def main(filas, columnas):
    ...
    with open('TABLAS_Patrón_Grande/RAINBOW_TABLE_NUM_Patrón_'+filas+'x'+columnas, 'wb') as fh:
        pickle.dump(rt, fh)
    col(rt)
