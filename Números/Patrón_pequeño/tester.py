...
"""
    ...
    for columna in [50, 100]:
        ...
        rainbow_num_Patrón_pequeño_tester.busq(20000, columna)

    for columna in [40, 100]:
        print('%d x %d' % (25000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(25000, columna)

    for columna in [20, 50, 100]:
        print('%d x %d' % (50000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(50000, columna)

    for columna in [10, 50, 100]:
        print('%d x %d' % (100000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(100000, columna)

    for columna in [5]:
        print('%d x %d' % (200000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(200000, columna)

    for columna in [4, 50, 100]:
        print('%d x %d' % (250000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(250000, columna)

    for columna in [2, 50, 100]:
        print('%d x %d' % (500000, columna))
        rainbow_num_Patrón_pequeño_tester.busq(500000, columna)
