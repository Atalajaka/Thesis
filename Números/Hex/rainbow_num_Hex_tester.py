...
def busq(filas, columnas):
        ...
        rT = 'TABLAS_Hex/RAINBOW_TABLE_NUM_Hex_'+str(filas)+'x'+str(columnas)
...
def main(filas, columnas):
    ...
    for p in product(digits, repeat = 6):
        ...
        # La reconstrucción será empleando el hash en hexadecimal
    ...
    with open('TABLAS_Hex/RAINBOW_TABLE_NUM_Hex_'+filas+'x'+columnas, 'wb') as fh:
        pickle.dump(rt, fh)
    col(rt)
